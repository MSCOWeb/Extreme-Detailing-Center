...
$to = "stephen@msmdesignz.com"; // Where submissions are sent. Leave blank if using $_POST['to']
$bcc = "";
$from_name = "Valhalla Detailing";
$from_email = "info@valhalladetailing.com"; // Where email to company is coming from
$subject = "Valhalla Schedule Form Submission"; // Subject of email to company. Leave blank if using $_POST['subject']
...
$return_subject = "Trion Contact Form"; // Subject of email sent to client
$return_message = <<< EOT
    <html><body>
    <p>Thank you for your interest in Trion! Your inquiry is important to us and one of our team members will be contacting you shortly to see how we can assist you.</p>
    <p>For immediate assistance, please call us at (877) 652-6712.</p>
    <p>Thank You!<br><br>
    Best regards,<br><br>
    The Trion Team</p>
    </body></html>
